...
namespace TextAnalysisAppTest
{
    public class TextParserTests
    {
        ...
        private static object[] WordCases =
        {
            ...
            new object[] { Sentences[4], new string[] { "Шаблоны", "проектирования", "подразделяются", "на", "следующие", "группы", "порождающие", "поведенческие", "и", "структурные", "Поведенческие", "шаблоны", "отвечают", "за", "поведение", "порождающие", "за", "создание", "объектов", "Какие-то", "шаблоны", "можно", "объединить", "друг", "с", "другом", "а", "некоторые", "нет" } }
        };
